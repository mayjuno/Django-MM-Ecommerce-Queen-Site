...
class Product(models.Model):
    ...
    discount = models.CharField(max_length=10, choices=DISCOUNT, default='False')
...
# For Product Colour and Size Variation
class Color(models.Model):
    name = models.CharField(max_length=20)
    myanmar_name = models.CharField(max_length=100)
